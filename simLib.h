...
typedef simInt (__cdecl *ptrSimAddGraphDataStream)(simInt graphHandle,const simChar* streamName,const simChar* unitStr,simInt options,const simFloat* color,simFloat cyclicRange);
typedef simInt (__cdecl *ptrSimDestroyGraphCurve)(simInt graphHandle,simInt curveId);
typedef simInt (__cdecl *ptrSimSetGraphDataStreamTransformation)(simInt graphHandle,simInt streamId,simInt trType,simFloat mult,simFloat off,simInt movingAvgPeriod);
typedef simInt (__cdecl *ptrSimDuplicateGraphCurveToStatic)(simInt graphHandle,simInt curveId,const simChar* curveName);
typedef simInt (__cdecl *ptrSimAddGraphCurve)(simInt graphHandle,simInt dim,const simInt* streamIds,const simFloat* defaultValues,const simChar* curveName,const simChar* unitStr,simInt options,const simFloat* color,simInt curveWidth);
typedef simInt (__cdecl *ptrSimSetGraphDataStreamValue)(simInt graphHandle,simInt streamId,simFloat value);
...
extern ptrSimAddGraphDataStream simAddGraphDataStream;
extern ptrSimDestroyGraphCurve simDestroyGraphCurve;
extern ptrSimSetGraphDataStreamTransformation simSetGraphDataStreamTransformation;
extern ptrSimDuplicateGraphCurveToStatic simDuplicateGraphCurveToStatic;
extern ptrSimAddGraphCurve simAddGraphCurve;
extern ptrSimSetGraphDataStreamValue simSetGraphDataStreamValue;
