...
typedef simInt (__cdecl *ptrSimRegisterScriptFuncHook)(simInt scriptHandle,const simChar* systemFunction,const simChar* userFunction,simBool executeBefore,simInt options);
