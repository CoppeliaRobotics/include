...
typedef void (__cdecl *ptr_simGetVerticesLocalFrame)(const void* geometric,SIMDOUBLE* pos,SIMDOUBLE* quat);
...
typedef void (__cdecl *ptr_simGetCumulativeMeshes)(const void* geomInfo,SIMDOUBLE** vertices,int* verticesSize,int** indices,int* indicesSize);
