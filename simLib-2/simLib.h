...
#define LH false
    ...
    static int simGetStringProperty(long long int target, const char* pName, char** pState) { return SIM_API_SYMBOL(simGetStringProperty)(target,pName,pState); }
    ...
    static int simGetTableProperty(long long int target, const char* pName, char** buffer, int* bufferL) { return SIM_API_SYMBOL(simGetTableProperty)(target,pName,buffer,bufferL); }
    ...
    static int simGetBufferProperty(long long int target, const char* pName, char** buffer, int* bufferL) { return SIM_API_SYMBOL(simGetBufferProperty)(target,pName,buffer,bufferL); }
    ...
    static int simGetFloatArrayProperty(long long int target, const char* pName, double** v, int* vL) { return SIM_API_SYMBOL(simGetFloatArrayProperty)(target,pName,v,vL); }
    ...
    static int simGetIntArrayProperty(long long int target, const char* pName, int** v, int* vL) { return SIM_API_SYMBOL(simGetIntArrayProperty)(target,pName,v,vL); }
    ...
    static int simTransformImage(unsigned char* image,const int* resolution,int options,const double* floatParams,const int* intParams,void* reserved) { return SIM_API_SYMBOL(simTransformImage)(image,resolution,options,floatParams,intParams,reserved); }
    static const double* simGetOctreeVoxels(SIMHANDLE octreeHandle,int* ptCnt,void* reserved) { return SIM_API_SYMBOL(simGetOctreeVoxels)(octreeHandle,ptCnt,reserved); }
    static const double* simGetPointCloudPoints(SIMHANDLE pointCloudHandle,int* ptCnt,void* reserved) { return SIM_API_SYMBOL(simGetPointCloudPoints)(pointCloudHandle,ptCnt,reserved); }
    static int simGetObjectMatrix(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,double* matrix) { return SIM_API_SYMBOL(simGetObjectMatrix)(objectHandle,relativeToObjectHandle,matrix); }
    static int simSetObjectMatrix(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,const double* matrix) { return SIM_API_SYMBOL(simSetObjectMatrix)(objectHandle,relativeToObjectHandle,matrix); }
    static int simGetObjectPose(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,double* pose) { return SIM_API_SYMBOL(simGetObjectPose)(objectHandle,relativeToObjectHandle,pose); }
    static int simSetObjectPose(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,const double* pose) { return SIM_API_SYMBOL(simSetObjectPose)(objectHandle,relativeToObjectHandle,pose); }
    static int simGetObjectPosition(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,double* position) { return SIM_API_SYMBOL(simGetObjectPosition)(objectHandle,relativeToObjectHandle,position); }
    static int simSetObjectPosition(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,const double* position) { return SIM_API_SYMBOL(simSetObjectPosition)(objectHandle,relativeToObjectHandle,position); }
    static int simGetObjectOrientation(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,double* eulerAngles) { return SIM_API_SYMBOL(simGetObjectOrientation)(objectHandle,relativeToObjectHandle,eulerAngles); }
    static int simSetObjectOrientation(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,const double* eulerAngles) { return SIM_API_SYMBOL(simSetObjectOrientation)(objectHandle,relativeToObjectHandle,eulerAngles); }
    static int simGetJointPosition(SIMHANDLE objectHandle,double* position) { return SIM_API_SYMBOL(simGetJointPosition)(objectHandle,position); }
    static int simSetJointPosition(SIMHANDLE objectHandle,double position) { return SIM_API_SYMBOL(simSetJointPosition)(objectHandle,position); }
    static int simSetJointTargetPosition(SIMHANDLE objectHandle,double targetPosition) { return SIM_API_SYMBOL(simSetJointTargetPosition)(objectHandle,targetPosition); }
    static int simGetJointTargetPosition(SIMHANDLE objectHandle,double* targetPosition) { return SIM_API_SYMBOL(simGetJointTargetPosition)(objectHandle,targetPosition); }
    static int simGetJointTargetForce(SIMHANDLE jointHandle,double* forceOrTorque) { return SIM_API_SYMBOL(simGetJointTargetForce)(jointHandle,forceOrTorque); }
    static int simSetJointTargetForce(SIMHANDLE objectHandle,double forceOrTorque,bool signedValue) { return SIM_API_SYMBOL(simSetJointTargetForce)(objectHandle,forceOrTorque,signedValue); }
    static int simGetObjectChildPose(SIMHANDLE objectHandle,double* pose) { return SIM_API_SYMBOL(simGetObjectChildPose)(objectHandle,pose); }
    static int simSetObjectChildPose(SIMHANDLE objectHandle,const double* pose) { return SIM_API_SYMBOL(simSetObjectChildPose)(objectHandle,pose); }
    static int simGetJointInterval(SIMHANDLE objectHandle,bool* cyclic,double* interval) { return SIM_API_SYMBOL(simGetJointInterval)(objectHandle,cyclic,interval); }
    static int simSetJointInterval(SIMHANDLE objectHandle,bool cyclic,const double* interval) { return SIM_API_SYMBOL(simSetJointInterval)(objectHandle,cyclic,interval); }
    static int simBuildIdentityMatrix(double* matrix) { return SIM_API_SYMBOL(simBuildIdentityMatrix)(matrix); }
    static int simBuildMatrix(const double* position,const double* eulerAngles,double* matrix) { return SIM_API_SYMBOL(simBuildMatrix)(position,eulerAngles,matrix); }
    static int simBuildPose(const double* position,const double* eulerAngles,double* pose) { return SIM_API_SYMBOL(simBuildPose)(position,eulerAngles,pose); }
    static int simGetEulerAnglesFromMatrix(const double* matrix,double* eulerAngles) { return SIM_API_SYMBOL(simGetEulerAnglesFromMatrix)(matrix,eulerAngles); }
    static int simInvertMatrix(double* matrix) { return SIM_API_SYMBOL(simInvertMatrix)(matrix); }
    static int simMultiplyMatrices(const double* matrixIn1,const double* matrixIn2,double* matrixOut) { return SIM_API_SYMBOL(simMultiplyMatrices)(matrixIn1,matrixIn2,matrixOut); }
    static int simMultiplyPoses(const double* poseIn1,const double* poseIn2,double* poseOut) { return SIM_API_SYMBOL(simMultiplyPoses)(poseIn1,poseIn2,poseOut); }
    static int simInvertPose(double* pose) { return SIM_API_SYMBOL(simInvertPose)(pose); }
    static int simInterpolatePoses(const double* poseIn1,const double* poseIn2,double interpolFactor,double* poseOut) { return SIM_API_SYMBOL(simInterpolatePoses)(poseIn1,poseIn2,interpolFactor,poseOut); }
    static int simPoseToMatrix(const double* poseIn,double* matrixOut) { return SIM_API_SYMBOL(simPoseToMatrix)(poseIn,matrixOut); }
    static int simMatrixToPose(const double* matrixIn,double* poseOut) { return SIM_API_SYMBOL(simMatrixToPose)(matrixIn,poseOut); }
    static int simInterpolateMatrices(const double* matrixIn1,const double* matrixIn2,double interpolFactor,double* matrixOut) { return SIM_API_SYMBOL(simInterpolateMatrices)(matrixIn1,matrixIn2,interpolFactor,matrixOut); }
    static int simTransformVector(const double* matrix,double* vect) { return SIM_API_SYMBOL(simTransformVector)(matrix,vect); }
    static double simGetSimulationTime() { return SIM_API_SYMBOL(simGetSimulationTime)(); }
    static double simGetSystemTime() { return SIM_API_SYMBOL(simGetSystemTime)(); }
    static int simHandleProximitySensor(SIMHANDLE sensorHandle,double* detectedPoint,SIMHANDLE* detectedObjectHandle,double* normalVector) { return SIM_API_SYMBOL(simHandleProximitySensor)(sensorHandle,detectedPoint,detectedObjectHandle,normalVector); }
    static int simReadProximitySensor(SIMHANDLE sensorHandle,double* detectedPoint,SIMHANDLE* detectedObjectHandle,double* normalVector) { return SIM_API_SYMBOL(simReadProximitySensor)(sensorHandle,detectedPoint,detectedObjectHandle,normalVector); }
    static int simHandleDynamics(double deltaTime) { return SIM_API_SYMBOL(simHandleDynamics)(deltaTime); }
    static int simCheckProximitySensor(SIMHANDLE sensorHandle,SIMHANDLE entityHandle,double* detectedPoint) { return SIM_API_SYMBOL(simCheckProximitySensor)(sensorHandle,entityHandle,detectedPoint); }
    ...
    static int simCheckCollisionEx(SIMHANDLE entity1Handle,SIMHANDLE entity2Handle,double** intersectionSegments) { return SIM_API_SYMBOL(simCheckCollisionEx)(entity1Handle,entity2Handle,intersectionSegments); }
    static int simCheckDistance(SIMHANDLE entity1Handle,SIMHANDLE entity2Handle,double threshold,double* distanceData) { return SIM_API_SYMBOL(simCheckDistance)(entity1Handle,entity2Handle,threshold,distanceData); }
    static int simSetSimulationTimeStep(double timeStep) { return SIM_API_SYMBOL(simSetSimulationTimeStep)(timeStep); }
    static double simGetSimulationTimeStep() { return SIM_API_SYMBOL(simGetSimulationTimeStep)(); }
    static int simFloatingViewAdd(double posX,double posY,double sizeX,double sizeY,int options) { return SIM_API_SYMBOL(simFloatingViewAdd)(posX,posY,sizeX,sizeY,options); }
    static int simHandleGraph(SIMHANDLE graphHandle,double simulationTime) { return SIM_API_SYMBOL(simHandleGraph)(graphHandle,simulationTime); }
    static int simSetGraphStreamTransformation(SIMHANDLE graphHandle,int streamId,int trType,double mult,double off,int movingAvgPeriod) { return SIM_API_SYMBOL(simSetGraphStreamTransformation)(graphHandle,streamId,trType,mult,off,movingAvgPeriod); }
    ...
    static int simSetGraphStreamValue(SIMHANDLE graphHandle,int streamId,double value) { return SIM_API_SYMBOL(simSetGraphStreamValue)(graphHandle,streamId,value); }
    static int simSetJointTargetVelocity(SIMHANDLE objectHandle,double targetVelocity) { return SIM_API_SYMBOL(simSetJointTargetVelocity)(objectHandle,targetVelocity); }
    static int simGetJointTargetVelocity(SIMHANDLE objectHandle,double* targetVelocity) { return SIM_API_SYMBOL(simGetJointTargetVelocity)(objectHandle,targetVelocity); }
    static int simScaleObjects(const SIMHANDLE* objectHandles,int objectCount,double scalingFactor,bool scalePositionsToo) { return SIM_API_SYMBOL(simScaleObjects)(objectHandles,objectCount,scalingFactor,scalePositionsToo); }
    static SIMHANDLE simAddDrawingObject(int objectType,double size,double duplicateTolerance,SIMHANDLE parentObjectHandle,int maxItemCount,const float* color,const float* setToNULL,const float* setToNULL2,const float* setToNULL3) { return SIM_API_SYMBOL(simAddDrawingObject)(objectType,size,duplicateTolerance,parentObjectHandle,maxItemCount,color,setToNULL,setToNULL2,setToNULL3); }
    static int simAddGraphStream(SIMHANDLE graphHandle,const char* streamName,const char* unitStr,int options,const float* color,double cyclicRange) { return SIM_API_SYMBOL(simAddGraphStream)(graphHandle,streamName,unitStr,options,color,cyclicRange); }
    static int simAddDrawingObjectItem(SIMHANDLE objectHandle,const double* itemData) { return SIM_API_SYMBOL(simAddDrawingObjectItem)(objectHandle,itemData); }
    static double simGetObjectSizeFactor(SIMHANDLE objectHandle) { return SIM_API_SYMBOL(simGetObjectSizeFactor)(objectHandle); }
    static int simReadForceSensor(SIMHANDLE objectHandle,double* forceVector,double* torqueVector) { return SIM_API_SYMBOL(simReadForceSensor)(objectHandle,forceVector,torqueVector); }
    static int simGetVelocity(SIMHANDLE shapeHandle,double* linearVelocity,double* angularVelocity) { return SIM_API_SYMBOL(simGetVelocity)(shapeHandle,linearVelocity,angularVelocity); }
    static int simGetObjectVelocity(SIMHANDLE objectHandle,double* linearVelocity,double* angularVelocity) { return SIM_API_SYMBOL(simGetObjectVelocity)(objectHandle,linearVelocity,angularVelocity); }
    static int simGetJointVelocity(SIMHANDLE jointHandle,double* velocity) { return SIM_API_SYMBOL(simGetJointVelocity)(jointHandle,velocity); }
    static int simAddForceAndTorque(SIMHANDLE shapeHandle,const double* force,const double* torque) { return SIM_API_SYMBOL(simAddForceAndTorque)(shapeHandle,force,torque); }
    static int simAddForce(SIMHANDLE shapeHandle,const double* position,const double* force) { return SIM_API_SYMBOL(simAddForce)(shapeHandle,position,force); }
    ...
    static int simGetContactInfo(int dynamicPass,SIMHANDLE objectHandle,int index,SIMHANDLE* objectHandles,double* contactInfo) { return SIM_API_SYMBOL(simGetContactInfo)(dynamicPass,objectHandle,index,objectHandles,contactInfo); }
    ...
    static SIMHANDLE simImportShape(int fileformat,const char* pathAndFilename,int options,double identicalVerticeTolerance,double scalingFactor) { return SIM_API_SYMBOL(simImportShape)(fileformat,pathAndFilename,options,identicalVerticeTolerance,scalingFactor); }
    static int simImportMesh(int fileformat,const char* pathAndFilename,int options,double identicalVerticeTolerance,double scalingFactor,double*** vertices,int** verticesSizes,int*** indices,int** indicesSizes,double*** reserved,char*** names) { return SIM_API_SYMBOL(simImportMesh)(fileformat,pathAndFilename,options,identicalVerticeTolerance,scalingFactor,vertices,verticesSizes,indices,indicesSizes,reserved,names); }
    static int simExportMesh(int fileformat,const char* pathAndFilename,int options,double scalingFactor,int elementCount,const double** vertices,const int* verticesSizes,const int** indices,const int* indicesSizes,double** reserved,const char** names) { return SIM_API_SYMBOL(simExportMesh)(fileformat,pathAndFilename,options,scalingFactor,elementCount,vertices,verticesSizes,indices,indicesSizes,reserved,names); }
    ...
    static SIMHANDLE simCreateMeshShape(int options,double shadingAngle,const double* vertices,int verticesSize,const int* indices,int indicesSize,double* reserved) { return SIM_API_SYMBOL(simCreateMeshShape)(options,shadingAngle,vertices,verticesSize,indices,indicesSize,reserved); }
    static SIMHANDLE simCreatePrimitiveShape(int primitiveType,const double* sizes,int options) { return SIM_API_SYMBOL(simCreatePrimitiveShape)(primitiveType,sizes,options); }
    static SIMHANDLE simCreateHeightfieldShape(int options,double shadingAngle,int xPointCount,int yPointCount,double xSize,const double* heights) { return SIM_API_SYMBOL(simCreateHeightfieldShape)(options,shadingAngle,xPointCount,yPointCount,xSize,heights); }
    static int simGetShapeMesh(SIMHANDLE shapeHandle,double** vertices,int* verticesSize,int** indices,int* indicesSize,double** normals) { return SIM_API_SYMBOL(simGetShapeMesh)(shapeHandle,vertices,verticesSize,indices,indicesSize,normals); }
    static SIMHANDLE simCreateJoint(int jointType,int jointMode,int options,const double* sizes,const double* reservedA,const double* reservedB) { return SIM_API_SYMBOL(simCreateJoint)(jointType,jointMode,options,sizes,reservedA,reservedB); }
    static SIMHANDLE simCreateDummy(double size,const float* reserved) { return SIM_API_SYMBOL(simCreateDummy)(size,reserved); }
    ...
    static SIMHANDLE simCreateForceSensor(int options,const int* intParams,const double* floatParams,const double* reserved) { return SIM_API_SYMBOL(simCreateForceSensor)(options,intParams,floatParams,reserved); }
    static SIMHANDLE simCreateVisionSensor(int options,const int* intParams,const double* floatParams,const double* reserved) { return SIM_API_SYMBOL(simCreateVisionSensor)(options,intParams,floatParams,reserved); }
    static SIMHANDLE simCreateProximitySensor(int sensorType,int subType,int options,const int* intParams,const double* floatParams,const double* reserved) { return SIM_API_SYMBOL(simCreateProximitySensor)(sensorType,subType,options,intParams,floatParams,reserved); }
    static int simGetRotationAxis(const double* matrixStart,const double* matrixGoal,double* axis,double* angle) { return SIM_API_SYMBOL(simGetRotationAxis)(matrixStart,matrixGoal,axis,angle); }
    static int simRotateAroundAxis(const double* matrixIn,const double* axis,const double* axisPos,double angle,double* matrixOut) { return SIM_API_SYMBOL(simRotateAroundAxis)(matrixIn,axis,axisPos,angle,matrixOut); }
    static int simGetJointForce(SIMHANDLE jointHandle,double* forceOrTorque) { return SIM_API_SYMBOL(simGetJointForce)(jointHandle,forceOrTorque); }
    static int simCameraFitToView(SIMHANDLE viewHandleOrIndex,int objectCount,const SIMHANDLE* objectHandles,int options,double scaling) { return SIM_API_SYMBOL(simCameraFitToView)(viewHandleOrIndex,objectCount,objectHandles,options,scaling); }
    static int simHandleVisionSensor(SIMHANDLE visionSensorHandle,double** auxValues,int** auxValuesCount) { return SIM_API_SYMBOL(simHandleVisionSensor)(visionSensorHandle,auxValues,auxValuesCount); }
    static int simReadVisionSensor(SIMHANDLE visionSensorHandle,double** auxValues,int** auxValuesCount) { return SIM_API_SYMBOL(simReadVisionSensor)(visionSensorHandle,auxValues,auxValuesCount); }
    static int simCheckVisionSensor(SIMHANDLE visionSensorHandle,SIMHANDLE entityHandle,double** auxValues,int** auxValuesCount) { return SIM_API_SYMBOL(simCheckVisionSensor)(visionSensorHandle,entityHandle,auxValues,auxValuesCount); }
    static unsigned char* simGetVisionSensorImg(SIMHANDLE sensorHandle,int options,double rgbaCutOff,const int* pos,const int* size,int* resolution) { return SIM_API_SYMBOL(simGetVisionSensorImg)(sensorHandle,options,rgbaCutOff,pos,size,resolution); }
    ...
    static int simGetObjectQuaternion(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,double* quaternion) { return SIM_API_SYMBOL(simGetObjectQuaternion)(objectHandle,relativeToObjectHandle,quaternion); }
    static int simSetObjectQuaternion(SIMHANDLE objectHandle,SIMHANDLE relativeToObjectHandle,const double* quaternion) { return SIM_API_SYMBOL(simSetObjectQuaternion)(objectHandle,relativeToObjectHandle,quaternion); }
    static SIMHANDLE simConvexDecompose(SIMHANDLE shapeHandle,int options,const int* intParams,const double* floatParams) { return SIM_API_SYMBOL(simConvexDecompose)(shapeHandle,options,intParams,floatParams); }
    static int simWriteTexture(SIMHANDLE textureId,int options,const char* data,int posX,int posY,int sizeX,int sizeY,double interpol) { return SIM_API_SYMBOL(simWriteTexture)(textureId,options,data,posX,posY,sizeX,sizeY,interpol); }
    static SIMHANDLE simCreateTexture(const char* fileName,int options,const double* planeSizes,const double* scalingUV,const double* xy_g,int fixedResolution,int* textureId,int* resolution,const void* reserved) { return SIM_API_SYMBOL(simCreateTexture)(fileName,options,planeSizes,scalingUV,xy_g,fixedResolution,textureId,resolution,reserved); }
    static int simGetShapeGeomInfo(SIMHANDLE shapeHandle,int* intData,double* floatData,void* reserved) { return SIM_API_SYMBOL(simGetShapeGeomInfo)(shapeHandle,intData,floatData,reserved); }
    static int simScaleObject(SIMHANDLE objectHandle,double xScale,double yScale,double zScale,int options) { return SIM_API_SYMBOL(simScaleObject)(objectHandle,xScale,yScale,zScale,options); }
    static int simSetShapeTexture(SIMHANDLE shapeHandle,SIMHANDLE textureId,int mappingMode,int options,const double* uvScaling,const double* position,const double* orientation) { return SIM_API_SYMBOL(simSetShapeTexture)(shapeHandle,textureId,mappingMode,options,uvScaling,position,orientation); }
    static int simGetQHull(const double* inVertices,int inVerticesL,double** verticesOut,int* verticesOutL,int** indicesOut,int* indicesOutL,int reserved1,const double* reserved2) { return SIM_API_SYMBOL(simGetQHull)(inVertices,inVerticesL,verticesOut,verticesOutL,indicesOut,indicesOutL,reserved1,reserved2); }
    ...
    static int simComputeMassAndInertia(SIMHANDLE shapeHandle,double density) { return SIM_API_SYMBOL(simComputeMassAndInertia)(shapeHandle,density); }
    static SIMHANDLE simCreateOctree(double voxelSize,int options,double pointSize,void* reserved) { return SIM_API_SYMBOL(simCreateOctree)(voxelSize,options,pointSize,reserved); }
    static SIMHANDLE simCreatePointCloud(double maxVoxelSize,int maxPtCntPerVoxel,int options,double pointSize,void* reserved) { return SIM_API_SYMBOL(simCreatePointCloud)(maxVoxelSize,maxPtCntPerVoxel,options,pointSize,reserved); }
    static int simSetPointCloudOptions(SIMHANDLE pointCloudHandle,double maxVoxelSize,int maxPtCntPerVoxel,int options,double pointSize,void* reserved) { return SIM_API_SYMBOL(simSetPointCloudOptions)(pointCloudHandle,maxVoxelSize,maxPtCntPerVoxel,options,pointSize,reserved); }
    static int simGetPointCloudOptions(SIMHANDLE pointCloudHandle,double* maxVoxelSize,int* maxPtCntPerVoxel,int* options,double* pointSize,void* reserved) { return SIM_API_SYMBOL(simGetPointCloudOptions)(pointCloudHandle,maxVoxelSize,maxPtCntPerVoxel,options,pointSize,reserved); }
    static int simInsertVoxelsIntoOctree(SIMHANDLE octreeHandle,int options,const double* pts,int ptCnt,const unsigned char* color,const unsigned int* tag,void* reserved) { return SIM_API_SYMBOL(simInsertVoxelsIntoOctree)(octreeHandle,options,pts,ptCnt,color,tag,reserved); }
    static int simRemoveVoxelsFromOctree(SIMHANDLE octreeHandle,int options,const double* pts,int ptCnt,void* reserved) { return SIM_API_SYMBOL(simRemoveVoxelsFromOctree)(octreeHandle,options,pts,ptCnt,reserved); }
    static int simInsertPointsIntoPointCloud(SIMHANDLE pointCloudHandle,int options,const double* pts,int ptCnt,const unsigned char* color,void* optionalValues) { return SIM_API_SYMBOL(simInsertPointsIntoPointCloud)(pointCloudHandle,options,pts,ptCnt,color,optionalValues); }
    static int simRemovePointsFromPointCloud(SIMHANDLE pointCloudHandle,int options,const double* pts,int ptCnt,double tolerance,void* reserved) { return SIM_API_SYMBOL(simRemovePointsFromPointCloud)(pointCloudHandle,options,pts,ptCnt,tolerance,reserved); }
    static int simIntersectPointsWithPointCloud(SIMHANDLE pointCloudHandle,int options,const double* pts,int ptCnt,double tolerance,void* reserved) { return SIM_API_SYMBOL(simIntersectPointsWithPointCloud)(pointCloudHandle,options,pts,ptCnt,tolerance,reserved); }
    static int simInsertObjectIntoPointCloud(SIMHANDLE pointCloudHandle,SIMHANDLE objectHandle,int options,double gridSize,const unsigned char* color,void* optionalValues) { return SIM_API_SYMBOL(simInsertObjectIntoPointCloud)(pointCloudHandle,objectHandle,options,gridSize,color,optionalValues); }
    static int simSubtractObjectFromPointCloud(SIMHANDLE pointCloudHandle,SIMHANDLE objectHandle,int options,double tolerance,void* reserved) { return SIM_API_SYMBOL(simSubtractObjectFromPointCloud)(pointCloudHandle,objectHandle,options,tolerance,reserved); }
    static int simCheckOctreePointOccupancy(SIMHANDLE octreeHandle,int options,const double* points,int ptCnt,unsigned int* tag,unsigned long long int* location,void* reserved) { return SIM_API_SYMBOL(simCheckOctreePointOccupancy)(octreeHandle,options,points,ptCnt,tag,location,reserved); }
    static int simApplyTexture(SIMHANDLE shapeHandle,const double* textureCoordinates,int textCoordSize,const unsigned char* texture,const int* textureResolution,int options) { return SIM_API_SYMBOL(simApplyTexture)(shapeHandle,textureCoordinates,textCoordSize,texture,textureResolution,options); }
    static int simSetJointDependency(SIMHANDLE jointHandle,SIMHANDLE masterJointHandle,double offset,double multCoeff) { return SIM_API_SYMBOL(simSetJointDependency)(jointHandle,masterJointHandle,offset,multCoeff); }
    static int simGetJointDependency(SIMHANDLE jointHandle,SIMHANDLE* masterJointHandle,double* offset,double* multCoeff) { return SIM_API_SYMBOL(simGetJointDependency)(jointHandle,masterJointHandle,offset,multCoeff); }
    static int simGetShapeMass(SIMHANDLE shapeHandle,double* mass) { return SIM_API_SYMBOL(simGetShapeMass)(shapeHandle,mass); }
    static int simSetShapeMass(SIMHANDLE shapeHandle,double mass) { return SIM_API_SYMBOL(simSetShapeMass)(shapeHandle,mass); }
    static int simGetShapeInertia(SIMHANDLE shapeHandle,double* inertiaMatrix,double* transformationMatrix) { return SIM_API_SYMBOL(simGetShapeInertia)(shapeHandle,inertiaMatrix,transformationMatrix); }
    static int simSetShapeInertia(SIMHANDLE shapeHandle,const double* inertiaMatrix,const double* transformationMatrix) { return SIM_API_SYMBOL(simSetShapeInertia)(shapeHandle,inertiaMatrix,transformationMatrix); }
    static SIMHANDLE simGenerateShapeFromPath(const double* path,int pathSize,const double* section,int sectionSize,int options,const double* upVector,double reserved) { return SIM_API_SYMBOL(simGenerateShapeFromPath)(path,pathSize,section,sectionSize,options,upVector,reserved); }
    static double simGetClosestPosOnPath(const double* path,int pathSize,const double* pathLengths,const double* absPt) { return SIM_API_SYMBOL(simGetClosestPosOnPath)(path,pathSize,pathLengths,absPt); }
    static void _simGetObjectLocalTransformation(const void* object,double* pos,double* quat,bool excludeFirstJointTransformation) { return SIM_API_SYMBOL(_simGetObjectLocalTransformation)(object,pos,quat,excludeFirstJointTransformation); }
    static void _simSetObjectLocalTransformation(void* object,const double* pos,const double* quat,double simTime) { return SIM_API_SYMBOL(_simSetObjectLocalTransformation)(object,pos,quat,simTime); }
    static void _simDynReportObjectCumulativeTransformation(void* object,const double* pos,const double* quat,double simTime) { return SIM_API_SYMBOL(_simDynReportObjectCumulativeTransformation)(object,pos,quat,simTime); }
    static void _simSetObjectCumulativeTransformation(void* object,const double* pos,const double* quat,bool keepChildrenInPlace) { return SIM_API_SYMBOL(_simSetObjectCumulativeTransformation)(object,pos,quat,keepChildrenInPlace); }
    static void _simGetObjectCumulativeTransformation(const void* object,double* pos,double* quat,bool excludeFirstJointTransformation) { return SIM_API_SYMBOL(_simGetObjectCumulativeTransformation)(object,pos,quat,excludeFirstJointTransformation); }
    static void _simSetJointVelocity(const void* joint,double vel) { return SIM_API_SYMBOL(_simSetJointVelocity)(joint,vel); }
    static void _simSetJointPosition(const void* joint,double pos) { return SIM_API_SYMBOL(_simSetJointPosition)(joint,pos); }
    static double _simGetJointPosition(const void* joint) { return SIM_API_SYMBOL(_simGetJointPosition)(joint); }
    static void _simSetDynamicMotorPositionControlTargetPosition(const void* joint,double pos) { return SIM_API_SYMBOL(_simSetDynamicMotorPositionControlTargetPosition)(joint,pos); }
    static void _simGetInitialDynamicVelocity(const void* shape,double* vel) { return SIM_API_SYMBOL(_simGetInitialDynamicVelocity)(shape,vel); }
    static void _simSetInitialDynamicVelocity(void* shape,const double* vel) { return SIM_API_SYMBOL(_simSetInitialDynamicVelocity)(shape,vel); }
    static void _simGetInitialDynamicAngVelocity(const void* shape,double* angularVel) { return SIM_API_SYMBOL(_simGetInitialDynamicAngVelocity)(shape,angularVel); }
    static void _simSetInitialDynamicAngVelocity(void* shape,const double* angularVel) { return SIM_API_SYMBOL(_simSetInitialDynamicAngVelocity)(shape,angularVel); }
    static void _simSetShapeDynamicVelocity(void* shape,const double* linear,const double* angular,double simTime) { return SIM_API_SYMBOL(_simSetShapeDynamicVelocity)(shape,linear,angular,simTime); }
    static void _simGetAdditionalForceAndTorque(const void* shape,double* force,double* torque) { return SIM_API_SYMBOL(_simGetAdditionalForceAndTorque)(shape,force,torque); }
    static bool _simGetJointPositionInterval(const void* joint,double* minValue,double* rangeValue) { return SIM_API_SYMBOL(_simGetJointPositionInterval)(joint,minValue,rangeValue); }
    static double _simGetDynamicMotorTargetPosition(const void* joint) { return SIM_API_SYMBOL(_simGetDynamicMotorTargetPosition)(joint); }
    static double _simGetDynamicMotorTargetVelocity(const void* joint) { return SIM_API_SYMBOL(_simGetDynamicMotorTargetVelocity)(joint); }
    static double _simGetDynamicMotorMaxForce(const void* joint) { return SIM_API_SYMBOL(_simGetDynamicMotorMaxForce)(joint); }
    static double _simGetDynamicMotorUpperLimitVelocity(const void* joint) { return SIM_API_SYMBOL(_simGetDynamicMotorUpperLimitVelocity)(joint); }
    static void _simSetDynamicMotorReflectedPositionFromDynamicEngine(void* joint,double pos,double simTime) { return SIM_API_SYMBOL(_simSetDynamicMotorReflectedPositionFromDynamicEngine)(joint,pos,simTime); }
    static void _simSetJointSphericalTransformation(void* joint,const double* quat,double simTime) { return SIM_API_SYMBOL(_simSetJointSphericalTransformation)(joint,quat,simTime); }
    static void _simAddForceSensorCumulativeForcesAndTorques(void* forceSensor,const double* force,const double* torque,int totalPassesCount,double simTime) { return SIM_API_SYMBOL(_simAddForceSensorCumulativeForcesAndTorques)(forceSensor,force,torque,totalPassesCount,simTime); }
    static void _simAddJointCumulativeForcesOrTorques(void* joint,double forceOrTorque,int totalPassesCount,double simTime) { return SIM_API_SYMBOL(_simAddJointCumulativeForcesOrTorques)(joint,forceOrTorque,totalPassesCount,simTime); }
    static double _simGetMass(const void* geomInfo) { return SIM_API_SYMBOL(_simGetMass)(geomInfo); }
    static double _simGetLocalInertiaInfo(const void* object,double* pos,double* quat,double* diagI) { return SIM_API_SYMBOL(_simGetLocalInertiaInfo)(object,pos,quat,diagI); }
    static void _simGetPurePrimitiveSizes(const void* geometric,double* sizes) { return SIM_API_SYMBOL(_simGetPurePrimitiveSizes)(geometric,sizes); }
    static void _simGetVerticesLocalFrame(const void* shape,const void* geometric,double* pos,double* quat) { return SIM_API_SYMBOL(_simGetVerticesLocalFrame)(shape,geometric,pos,quat); }
    static const double* _simGetHeightfieldData(const void* geometric,int* xCount,int* yCount,double* minHeight,double* maxHeight) { return SIM_API_SYMBOL(_simGetHeightfieldData)(geometric,xCount,yCount,minHeight,maxHeight); }
    static void _simGetCumulativeMeshes(const void* shape,const void* geomInfo,double** vertices,int* verticesSize,int** indices,int* indicesSize) { return SIM_API_SYMBOL(_simGetCumulativeMeshes)(shape,geomInfo,vertices,verticesSize,indices,indicesSize); }
    static void _simGetGravity(double* gravity) { return SIM_API_SYMBOL(_simGetGravity)(gravity); }
    ...
    static int _simHandleJointControl(const void* joint,int auxV,const int* inputValuesInt,const double* inputValuesFloat,double* outputValues) { return SIM_API_SYMBOL(_simHandleJointControl)(joint,auxV,inputValuesInt,inputValuesFloat,outputValues); }
    static int _simHandleCustomContact(SIMHANDLE objHandle1,SIMHANDLE objHandle2,int engine,int* dataInt,double* dataFloat) { return SIM_API_SYMBOL(_simHandleCustomContact)(objHandle1,objHandle2,engine,dataInt,dataFloat); }
    static double _simGetPureHollowScaling(const void* geometric) { return SIM_API_SYMBOL(_simGetPureHollowScaling)(geometric); }
    static void _simDynCallback(const int* intData,const double* floatData) { return SIM_API_SYMBOL(_simDynCallback)(intData,floatData); }
#else
