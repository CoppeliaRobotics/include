...
typedef int (__cdecl *SIM_API_SYMBOL(ptrSimSetMethodProperty))(long long int target, const char* pName, const void* v);
typedef int (__cdecl *SIM_API_SYMBOL(ptrSimGetMethodProperty))(long long int target, const char* pName, void** v);
...
typedef int (__cdecl *SIM_API_SYMBOL(ptrSimCallMethod))(long long int target, const char* name, SIMHANDLE inputStack, SIMHANDLE outputStack, SIMHANDLE nakedScript);
...
typedef int (__cdecl *SIM_API_SYMBOL(ptrSimPushColor4OntoStack))(SIMHANDLE stackHandle,const float* value);
...
typedef float* (__cdecl *SIM_API_SYMBOL(ptrSimGetStackColor4))(SIMHANDLE stackHandle);
...
extern SIM_API_SYMBOL(ptrSimSetMethodProperty) SIM_API_SYMBOL(simSetMethodProperty);
extern SIM_API_SYMBOL(ptrSimGetMethodProperty) SIM_API_SYMBOL(simGetMethodProperty);
...
extern SIM_API_SYMBOL(ptrSimPushColor4OntoStack) SIM_API_SYMBOL(simPushColor4OntoStack);
...
extern SIM_API_SYMBOL(ptrSimGetStackColor4) SIM_API_SYMBOL(simGetStackColor4);
...
static inline int simSetMethodProperty(long long int target, const char* pName, const void* v) { return SIM_API_SYMBOL(simSetMethodProperty)(target,pName,v); }
static inline int simGetMethodProperty(long long int target, const char* pName, void** v) { return SIM_API_SYMBOL(simGetMethodProperty)(target,pName,v); }
...
static inline int simCallMethod(long long int target, const char* name, SIMHANDLE inputStack, SIMHANDLE outputStack, SIMHANDLE nakedScript) { return SIM_API_SYMBOL(simCallMethod)(target, name, inputStack, outputStack, nakedScript); }
...
static inline int simPushColor4OntoStack(SIMHANDLE stackHandle,const float* value) { return SIM_API_SYMBOL(simPushColor4OntoStack)(stackHandle,value); }
...
static inline float* simGetStackColor4(SIMHANDLE stackHandle) { return SIM_API_SYMBOL(simGetStackColor4)(stackHandle); }
