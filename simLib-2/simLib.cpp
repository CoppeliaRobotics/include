...
SIM_API_SYMBOL(ptrSimSetEnumProperty) SIM_API_SYMBOL(simSetEnumProperty) = nullptr;
SIM_API_SYMBOL(ptrSimGetEnumProperty) SIM_API_SYMBOL(simGetEnumProperty) = nullptr;
...
SIM_API_SYMBOL(ptrSimSetStrEnumProperty) SIM_API_SYMBOL(simSetStrEnumProperty) = nullptr;
SIM_API_SYMBOL(ptrSimGetStrEnumProperty) SIM_API_SYMBOL(simGetStrEnumProperty) = nullptr;
...
SIM_API_SYMBOL(ptrSimSetStringArrayProperty) SIM_API_SYMBOL(simSetStringArrayProperty) = nullptr;
SIM_API_SYMBOL(ptrSimGetStringArrayProperty) SIM_API_SYMBOL(simGetStringArrayProperty) = nullptr;
SIM_API_SYMBOL(ptrSimSetMethodProperty) SIM_API_SYMBOL(simSetMethodProperty) = nullptr;
SIM_API_SYMBOL(ptrSimGetMethodProperty) SIM_API_SYMBOL(simGetMethodProperty) = nullptr;
...
SIM_API_SYMBOL(ptrSimPushColorOntoStack) SIM_API_SYMBOL(simPushColorOntoStack) = nullptr;
...
SIM_API_SYMBOL(ptrSimGetStackColor) SIM_API_SYMBOL(simGetStackColor) = nullptr;
...
int SIM_API_SYMBOL(getSimProcAddresses)(LIBRARY lib)
{
    ...
    SIM_API_SYMBOL(simSetEnumProperty) = (SIM_API_SYMBOL(ptrSimSetEnumProperty))(_getProcAddress(lib, "simSetIntProperty", false));
    SIM_API_SYMBOL(simGetEnumProperty) = (SIM_API_SYMBOL(ptrSimGetEnumProperty))(_getProcAddress(lib, "simGetIntProperty", false));
    ...
    SIM_API_SYMBOL(simSetStrEnumProperty) = (SIM_API_SYMBOL(ptrSimSetStrEnumProperty))(_getProcAddress(lib, "simSetStrEnumProperty", false));
    SIM_API_SYMBOL(simGetStrEnumProperty) = (SIM_API_SYMBOL(ptrSimGetStrEnumProperty))(_getProcAddress(lib, "simGetStrEnumProperty", false));
    ...
    SIM_API_SYMBOL(simSetStringArrayProperty) = (SIM_API_SYMBOL(ptrSimSetStringArrayProperty))(_getProcAddress(lib, "simSetStringArrayProperty", false));
    SIM_API_SYMBOL(simGetStringArrayProperty) = (SIM_API_SYMBOL(ptrSimGetStringArrayProperty))(_getProcAddress(lib, "simGetStringArrayProperty2", false));
    SIM_API_SYMBOL(simSetMethodProperty) = (SIM_API_SYMBOL(ptrSimSetMethodProperty))(_getProcAddress(lib, "simSetMethodProperty", false));
    SIM_API_SYMBOL(simGetMethodProperty) = (SIM_API_SYMBOL(ptrSimGetMethodProperty))(_getProcAddress(lib, "simGetMethodProperty", false));
    ...
    SIM_API_SYMBOL(simPushColorOntoStack) = (SIM_API_SYMBOL(ptrSimPushColorOntoStack))(_getProcAddress(lib,"simPushColorOntoStack",false, LH));
    ...
    SIM_API_SYMBOL(simGetStackColor) = (SIM_API_SYMBOL(ptrSimGetStackColor))(_getProcAddress(lib,"simGetStackColor",false, LH));
    ...
    if (SIM_API_SYMBOL(simSetEnumProperty) == nullptr)
    {
        printf("%s simSetEnumProperty\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simGetEnumProperty) == nullptr)
    {
        printf("%s simGetEnumProperty\n", couldNotFind);
        return 0;
    }
    ...
    {
        printf("%s simGetStringProperty2\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simSetStrEnumProperty) == nullptr)
    {
        printf("%s simSetStrEnumProperty\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simGetStrEnumProperty) == nullptr)
    {
        printf("%s simGetStrEnumProperty\n", couldNotFind);
        return 0;
    }
    ...
    if (SIM_API_SYMBOL(simSetMatrixProperty) == nullptr)
    {
    ...
    if (SIM_API_SYMBOL(simSetStringArrayProperty) == nullptr)
    {
        printf("%s simSetStringArrayProperty\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simGetStringArrayProperty) == nullptr)
    {
        printf("%s simGetStringArrayProperty\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simSetMethodProperty) == nullptr)
    {
        printf("%s simSetMethodProperty\n", couldNotFind);
        return 0;
    }
    if (SIM_API_SYMBOL(simGetMethodProperty) == nullptr)
    {
        printf("%s simGetMethodProperty\n", couldNotFind);
        return 0;
    }
    ...
    if (SIM_API_SYMBOL(simPushMatrixOntoStack) == nullptr)
    {
    ...
    if (SIM_API_SYMBOL(simPushColorOntoStack) == nullptr)
    {
        printf("%s simPushColorOntoStack\n",couldNotFind);
        return 0;
    }
    ...
    if (SIM_API_SYMBOL(simGetStackColor) == nullptr)
    {
        printf("%s simGetStackColor\n",couldNotFind);
        return 0;
    }
