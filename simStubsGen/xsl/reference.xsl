...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="allCommands" select="/plugin/command[not(@skip-documentation='true') and not(@deprecated='true')]" />
    <xsl:variable name="allEnums" select="/plugin/enum[not(@skip-documentation='true') and not(@deprecated='true')]" />
    <xsl:variable name="allStructs" select="/plugin/struct[not(@skip-documentation='true') and not(@deprecated='true')]" />
    <xsl:variable name="allScriptFunctions" select="/plugin/script-function[not(@skip-documentation='true') and not(@deprecated='true')]" />
    ...
    <xsl:template name="renderRelated">
        ...
        <xsl:for-each select="categories/category">
            ...
            <xsl:for-each select="$allCommands">
                    ...
                    <table class="allEncompassingTable">
                        ...
                        <tr>
                            <td id="structs" class="section">
                                ...
                                <xsl:if test="$allStructs">
                                    ...
                                    <xsl:for-each select="$allStructs">
                        ...
                        <tr>
                            <td id="scriptFunctions" class="section">
                                ...
                                <xsl:if test="$allScriptFunctions">
                                    <br/>
                                    <br/>
                                    ...
                                    <xsl:for-each select="$allScriptFunctions">
