...
typedef int (__cdecl *ptrSimSetMatrix3x3Property)(int target, const char* pName, const double* pState);
typedef int (__cdecl *ptrSimGetMatrix3x3Property)(int target, const char* pName, double* pState);
typedef int (__cdecl *ptrSimSetMatrix4x4Property)(int target, const char* pName, const double* pState);
typedef int (__cdecl *ptrSimGetMatrix4x4Property)(int target, const char* pName, double* pState);
