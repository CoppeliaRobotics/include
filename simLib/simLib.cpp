...
int SIM_API_SYMBOL(getSimProcAddresses)(LIBRARY lib)
{
    ...
    SIM_API_SYMBOL(simGetStringProperty) = (SIM_API_SYMBOL(ptrSimGetStringProperty))(_getProcAddress(lib, "simGetStringProperty", false));
    SIM_API_SYMBOL(simGetTableProperty) = (SIM_API_SYMBOL(ptrSimGetTableProperty))(_getProcAddress(lib, "simGetTableProperty", false));
    SIM_API_SYMBOL(simGetBufferProperty) = (SIM_API_SYMBOL(ptrSimGetBufferProperty))(_getProcAddress(lib, "simGetBufferProperty", false));
    SIM_API_SYMBOL(simGetFloatArrayProperty) = (SIM_API_SYMBOL(ptrSimGetFloatArrayProperty))(_getProcAddress(lib, "simGetFloatArrayProperty", false));
    SIM_API_SYMBOL(simGetIntArrayProperty) = (SIM_API_SYMBOL(ptrSimGetIntArrayProperty))(_getProcAddress(lib, "simGetIntArrayProperty", false));
