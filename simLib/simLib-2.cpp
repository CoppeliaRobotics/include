...
int getSimProcAddresses(LIBRARY lib)
{
    ...
    simGetStringProperty = (ptrSimGetStringProperty)(_getProcAddress(lib, "simGetStringProperty2", false));
    simSetTableProperty = (ptrSimSetTableProperty)(_getProcAddress(lib, "simSetTableProperty", false));
    simGetTableProperty = (ptrSimGetTableProperty)(_getProcAddress(lib, "simGetTableProperty2", false));
    simSetBufferProperty = (ptrSimSetBufferProperty)(_getProcAddress(lib, "simSetBufferProperty", false));
    simGetBufferProperty = (ptrSimGetBufferProperty)(_getProcAddress(lib, "simGetBufferProperty2", false));
    ...
    simGetFloatArrayProperty = (ptrSimGetFloatArrayProperty)(_getProcAddress(lib, "simGetFloatArrayProperty2", false));
    simSetIntArrayProperty = (ptrSimSetIntArrayProperty)(_getProcAddress(lib, "simSetIntArrayProperty", false));
    simGetIntArrayProperty = (ptrSimGetIntArrayProperty)(_getProcAddress(lib, "simGetIntArrayProperty2", false));
