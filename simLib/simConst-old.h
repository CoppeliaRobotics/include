...
enum { /* Physics engines params */
    ...
    sim_mujoco_dummy_solrefoverlapconstr1,
    sim_mujoco_dummy_solrefoverlapconstr2,
    sim_mujoco_dummy_solimpoverlapconstr1,
    sim_mujoco_dummy_solimpoverlapconstr2,
    sim_mujoco_dummy_solimpoverlapconstr3,
    sim_mujoco_dummy_solimpoverlapconstr4,
    sim_mujoco_dummy_solimpoverlapconstr5,
    sim_mujoco_dummy_torquescaleoverlapconstr,
