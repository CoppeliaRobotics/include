...
namespace sim
{
    ...
    inline void pushValueOntoStack(sim::handle_t stack, const variant_t& var)
    {
    ...
    inline void pushValueOntoStack(sim::handle_t stack, const std::map<std::string, variant_t>& table)
    {
