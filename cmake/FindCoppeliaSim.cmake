...
function(COPPELIASIM_ADD_LUA LUA_FILE)
    ...
    if(COPPELIASIM_ADD_LUA_SUBDIR)
        set(COPPELIASIM_ADD_LUA_DEST ${COPPELIASIM_LUA_DIR}/${COPPELIASIM_ADD_LUA_SUBDIR})
    else()
        set(COPPELIASIM_ADD_LUA_DEST ${COPPELIASIM_LUA_DIR})
    endif()
    install(FILES ${LUA_FILE} DESTINATION ${COPPELIASIM_ADD_LUA_DEST})
