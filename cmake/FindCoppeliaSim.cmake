...
if(DEFINED COPPELIASIM_SIMLIB_VERSION)
    set(COPPELIASIM_SIMLIB_NAME "simLib-${COPPELIASIM_SIMLIB_VERSION}")
else()
    set(COPPELIASIM_SIMLIB_NAME "simLib")
endif()
set(COPPELIASIM_SIMLIB_DIR "${COPPELIASIM_INCLUDE_DIR}/${COPPELIASIM_SIMLIB_NAME}")

if(DEFINED COPPELIASIM_SIMPLUSPLUS_VERSION)
    set(COPPELIASIM_SIMPLUSPLUS_NAME "simPlusPlus-${COPPELIASIM_SIMPLUSPLUS_VERSION}")
else()
    set(COPPELIASIM_SIMPLUSPLUS_NAME "simPlusPlus")
endif()
set(COPPELIASIM_SIMPLUSPLUS_DIR "${COPPELIASIM_INCLUDE_DIR}/${COPPELIASIM_SIMPLUSPLUS_NAME}")

message(STATUS "CoppeliaSim: using modules: ${COPPELIASIM_SIMLIB_NAME} ${COPPELIASIM_SIMPLUSPLUS_NAME}")

set(COPPELIASIM_CHECK_MODULE_DIRS
    "${COPPELIASIM_SIMLIB_DIR}"
    "${COPPELIASIM_SIMPLUSPLUS_DIR}"
)
...
set(COPPELIASIM_EXPORTED_SOURCES
    ...
    "${COPPELIASIM_SIMLIB_DIR}/simLib.cpp")
...
#include <iostream>
#include <${COPPELIASIM_SIMLIB_NAME}/simConst.h>
int main() {
    char sep = ';';
    std::cout
...
function(COPPELIASIM_ADD_PLUGIN PLUGIN_TARGET_NAME)
    ...
    if(NOT COPPELIASIM_ADD_PLUGIN_LEGACY)
        set(COPPELIASIM_EXPORTED_SOURCES "${COPPELIASIM_EXPORTED_SOURCES}" "${COPPELIASIM_SIMPLUSPLUS_DIR}/Lib.cpp" "${COPPELIASIM_SIMPLUSPLUS_DIR}/Plugin.cpp" PARENT_SCOPE)
        set(COPPELIASIM_EXPORTED_SOURCES "${COPPELIASIM_EXPORTED_SOURCES}" "${COPPELIASIM_SIMPLUSPLUS_DIR}/Lib.cpp" "${COPPELIASIM_SIMPLUSPLUS_DIR}/Plugin.cpp")
    endif()
